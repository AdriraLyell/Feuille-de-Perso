...
const ImportExportModal: React.FC<ImportExportModalProps> = ({ isOpen, onClose, onExportSuccess, onImportSuccess, variant }) => {
    ...
    const executeImport = async () => {
        ...
        if (analysis?.versionMismatch) {
            onAddLog(`${logMsg} (Migration effectuée). Nous vous conseillons de sauvegarder votre personnage immédiatement.`, 'success', 'both');
            setMigrationReport({
            ...
            <ThematicModal
                ...
                footer={
                    <div className="flex gap-3">
                        <ThematicButton variant="secondary" onClick={handleClose}>
                            Plus tard
                        </ThematicButton>
                        <ThematicButton variant="primary" onClick={() => { handleExport(); handleClose(); }}>
                ...
                <div className="flex flex-col items-center text-center space-y-4 py-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-slate-600 max-w-sm">
                            Toutes les anciennes données ont été migrées vers le nouveau format (bibliothèque de spécialisations, effets de traits, etc.).
                        </p>
                    </div>
                    ...
                    <div className="bg-amber-50 border border-amber-200 p-4 rounded-lg flex gap-3 text-left">
                        ...
                        <div className="text-xs text-amber-900 leading-relaxed">
                            ...
                            Nous vous conseillons vivement de sauvegarder votre personnage immédiatement pour pérenniser ces changements dans un nouveau fichier <code>.json</code>.
                        </div>
                    </div>
                </div>
            </ThematicModal>
