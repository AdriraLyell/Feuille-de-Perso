    ...
    return (
        <div className="grid grid-cols-2 gap-1 p-1">
            ...
            <button
                ...
                className="p-2 rounded hover:bg-red-900/40 text-stone-400 hover:text-red-400 transition-colors flex items-center justify-center"
            ...
            <button
                ...
                className={`p-2 rounded hover:bg-stone-700 transition-colors flex items-center justify-center ${editor.isActive({ textAlign: 'justify' }) ? 'text-amber-400 bg-stone-800' : 'text-stone-300'}`}
                title="Justifier"
            >
